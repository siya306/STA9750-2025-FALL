---
title: "Mini-Project #03: Visualizing & Maintaining NYC’s Green Canopy"
author: "Siya Aneja"
format:
  html:
    theme: journal
...
New York City’s Parks and Recreation Department manages nearly 900,000
...
The Forestry Tree Points dataset records each tree’s location, species,
...
We’ll use st_join() to attach each tree to the district polygon it lies
in.
...
New York City’s District 4 (Midtown East, Murray Hill, Kips Bay) has one
of Manhattan’s highest pedestrian use areas but comparatively lower
...
This proposal supports NYC Parks’ mission to expand equitable green
spaces. By improving District 4’s street trees, we create a healthier,
